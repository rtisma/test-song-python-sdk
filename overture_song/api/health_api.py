...
class HealthApi(object):
    ...
    def is_alive(self, **kwargs):  # noqa: E501
        """IsAlive  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.is_alive_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.is_alive_with_http_info(**kwargs)  # noqa: E501
            return data

    def is_alive_with_http_info(self, **kwargs):  # noqa: E501
        """IsAlive  # noqa: E501

        Checks if the server is running  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.is_alive_with_http_info(async_req=True)
        >>> result = thread.get()
